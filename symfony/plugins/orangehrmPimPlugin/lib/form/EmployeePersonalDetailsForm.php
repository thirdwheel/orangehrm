...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            ...
            'optGender' => new sfWidgetFormChoice(array('expanded' => true, 'choices' => array(1 => __("Male"), 2 => __("Female"), 3 => __("Non-Binary")))),
    ...
    private function getPersonalInfoValidators() {
        ...
        $validators = array(
            ...
            'optGender' => new sfValidatorChoice(array('required' => false,
                'choices' => array(Employee::GENDER_MALE, Employee::GENDER_FEMALE, Employee::GENDER_NONBIN),
                'multiple' => false)),
